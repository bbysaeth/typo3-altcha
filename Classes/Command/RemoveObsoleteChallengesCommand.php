...
class RemoveObsoleteChallengesCommand extends Command
{
    ...
    protected function configure(): void
    {
        ...
        $this->addOption('dry-run', null, InputOption::VALUE_NONE, 'Do not remove challenges, just show what would be removed');
        $this->addOption('include-solved-challenges', 'a', InputOption::VALUE_NONE, 'Include solved challenges');
    }
